...
keystream = random.randbytes(100)

print(type(keystream))

xored_bytes = bytes([_a ^ _b for _a, _b in zip(keystream, keystream)])

print(xored_bytes)

input_str = str(xored_bytes)
c = BitArray(hex=input_str)
print(c.bin)



# print(format(keystream, '100b'))

# print(format(keystream, '100b').replace(' ', ''))
# import binascii
